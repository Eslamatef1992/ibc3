...
const SummaryReport = ()=> {
    ...
    const searchSummaryReport = () => {
        ...
        if(company <= 0) {
            ...
            const axios = apiUrl.get("/reports/summary-report/?company="+company+"&branch="+branch+"&from_date="+from_date+"&to_date="+to_date);
            axios.then((response) => {
                const result_data = response.data;
                if(result_data.status == 1){
                    setSummary_report(result_data.data);
    ...
    return (
        ...
        <Layout>
            ...
            <HeaderTitle title={lang.summary_report} keywords='' description=''/>
                    ...
                    <div className="d-flex justify-content-between">
                        <div className="clearfix">
                            <div className="pd-t-5 pd-b-5 d-print-none">
                                <h2 className="pd-0 mg-0 tx-14 tx-dark tx-bold tx-uppercase">{lang.summary_report}</h2>
                            </div>
                            <div className="breadcrumb pd-0 mg-0 d-print-none">
                                ...
                                <Link className="breadcrumb-item" href="/reports">{lang.reports}</Link>
                                <span className="breadcrumb-item hidden-xs active">{lang.summary_report}</span>
                            </div>
                        </div>
                            ...
                            <div className="col-md-2 mt-3">
                                <div className="form-group">
                                    ...
                                    <div className="d-grid gap-2">
                                        <button type="submit" className={`btn btn-success pd-t-6-force pd-b-5-force mg-r-3 tx-uppercase ${searchButton?'disabled': ''}`} onClick={() => searchSummaryReport()}>{searchButton?lang.process: lang.search}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <tr className="">
                                            ...
                                            <th className="tx-center tx-uppercase" width="40%" valign="top">
                                                <span className='tx-uppercase tx-16 text-decoration-underline'>{lang.summary_report}</span>
                                            </th>
                            ...
                            <table className="table table-striped table-bordered" width="100%">
                                <thead className="tx-12 tx-uppercase">
                                    <tr>
                                        ...
                                        <th className="tx-center" colSpan={2} width="47%">{lang.purchase}</th>
                                        <th className="tx-center" colSpan={2} width="47%">{lang.sales}</th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <tr className="">
                                        ...
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_amount}/></td>
                                        <td className="tx-left">Sales Amount</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_amount}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(2).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Purchase Payment</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_paid_amount}/></td>
                                        <td className="tx-left">Sales Collection</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_paid_amount}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(3).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Purchase Due</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_due_amount}/></td>
                                        <td className="tx-left">Sales Due</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_due_amount}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(4).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Purchase Due Payment</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_due_payment}/></td>
                                        <td className="tx-left">Sales Due Collection</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_due_payment}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(5).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Purchase Return Amount</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_return_amount}/></td>
                                        <td className="tx-left">Sales Return Amount</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_return_amount}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(6).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Purchase Return Collection</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_return_paid_amount}/></td>
                                        <td className="tx-left">Sales Return Payment</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_return_paid_amount}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(7).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Purchase Return Due</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_return_due_amount}/></td>
                                        <td className="tx-left">Sales Return Due</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_return_due_amount}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(8).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Purchase Return Due Collection</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.purchase.purchase_return_due_payment}/></td>
                                        <td className="tx-left">Sales Return Due Payment</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.sales.sales_return_due_payment}/></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table className="table table-striped table-bordered" width="100%">
                                ...
                                <tbody>
                                    <tr className="">
                                        ...
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.receipt_payment.receipt.cash}/></td>
                                        <td className="tx-left">Cash</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.receipt_payment.payment.cash}/></td>
                                    </tr>
                                    <tr className="">
                                        <td className="tx-center">{(2).toString().padStart(2, '0')}</td>
                                        <td className="tx-left">Bank</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.receipt_payment.receipt.bank}/></td>
                                        <td className="tx-left">Bank</td>
                                        <td className="tx-right"><AccountsNumberFormat amount={summary_report.receipt_payment.payment.bank}/></td>
                                    </tr>
                                    
                                    <tr className="">
                                        <th className="tx-right tx-uppercase" colSpan={2}>{lang.total}</th>
                                        <th className="tx-right"><AccountsNumberFormat amount={summary_report.receipt_payment_amount.total_receipt_amount}/></th>

                                        <th className="tx-right tx-uppercase">{lang.total}</th>
                                        <th className="tx-right"><AccountsNumberFormat amount={summary_report.receipt_payment_amount.total_payment_amount}/></th>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table className="table table-striped table-bordered" width="100%">
                                <tbody>
                                    <tr className="">
                                        ...
                                        <td className="tx-right" width="15%"><AccountsNumberFormat amount={summary_report.fund_need.cash}/></td>
                                        <td className="tx-left" width="35%">Bank</td>
                                        <td className="tx-right" width="15%"><AccountsNumberFormat amount={summary_report.fund_need.bank}/></td>
                                    </tr>
                                </tbody>
                            </table> */}
                            <br/><br/><br/><br/>
