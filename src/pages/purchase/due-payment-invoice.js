...
const DuePaymentInvoice = ()=> {
    ...
    const total_paid    = due_payment_list.reduce((amount, data) => amount + parseFloat((data.supplier_payment_paid)), 0);

    const duePaymentData = ()=> {
        const axios = apiUrl.get("purchase/get-due-payment/?company="+company+"&branch="+branch+"&supplier="+supplier+"&payment_date="+payment_date);
        axios.then((response) => {
    ...
    return (
        <>
            <HeaderTitle title={lang.due_payment+' '+lang.invoice} keywords='' description='' />
                    ...
                    <div className="col-md-12 mg-b-15">
                        <div className="row clearfix mb-3">
                            ...
                            <div className="col-md-12 tx-center mt-3">
                                <h6 className="tx-center tx-bold tx-20 tx-uppercase tx-underline">{lang.due_payment+' '+lang.invoice}</h6>
                                <table width="100%">
                                    <tbody>
                                        <tr>
...
export default DuePaymentInvoice;