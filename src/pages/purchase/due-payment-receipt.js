...
const DuePaymentReceipt = ()=> {
    ...
    const total_payment_amount = due_payment_list.reduce((amount, data) => amount + parseFloat((data.supplier_payment_paid)), 0);
    ...
    return (
        <>
            <HeaderTitle title={lang.due_payment+' '+lang.receipt} keywords='' description=''/>
            ...
            <div className="invoice-pos">
                <div className="col tx-center tx-bold mb-3"> 
                    ...
                    <hr className='bd-top'/>
                    <h6 className="tx-center tx-bold tx-14 tx-uppercase tx-underline">{lang.due_payment+' '+lang.receipt}</h6>
...
export default DuePaymentReceipt;