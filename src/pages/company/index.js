        ...
        <Layout>
                                ...
                                <tbody>
                                    ...
                                    <tr className='' key={row.company_id}>
                                        ...
                                        <td className="tx-center">
                                            {/* {row.company_picture?.includes("/assets/images/") ?  */}
                                                <img src={`https://${row.company_picture}`} alt="Company Picture" width={20} height={20} />
                                        ...
                                        <td className="tx-center d-print-none">
                                            <Link className="text-warning mg-r-3" href="#" title={lang.project} onClick={() => formModalView(row.company_id)}><i className="fas fa-eye wd-16 mr-2"></i></Link>
            ...
            <div className={`modal fade zoomIn ${showFormModalView ? 'show d-block' : ''}`} >
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header bg-primary m-0 p-2">
                            <h6 className="modal-title text-white">{lang.view} {lang.project}</h6>
