                            ...
                            <table className="table table-striped table-bordered table-hover" ref={excelExportRef}>
                                <thead className="tx-12 tx-uppercase">
                                    <tr>
                                        ...
                                        <th className="tx-center" width="10%">{lang.link}</th>
                                        ...
                                        return(<>
                                            ...
                                            <>
                                                <tr className="" key={at_row.chart_of_accounts_id}>
                                                    ...
                                                    <th className="tx-center text-uppercase"></th>
                                                ...
                                                <>
                                                    <tr className="" key={ac_row.chart_of_accounts_id}>
                                                        ...
                                                        <th className="tx-left">{ac_row.chart_of_accounts_accounts_link}</th>
                                                        ...
                                                        <tr className="" key={cg_row.chart_of_accounts_id}>
                                                            ...
                                                            <th className="tx-left">{cg_row.chart_of_accounts_accounts_link}</th>
                                                            ...
                                                            <tr className="" key={gl_row.chart_of_accounts_id}>
                                                                ...
                                                                <th className="tx-left">{gl_row.chart_of_accounts_accounts_link}</th>
                                                                ...
                                                                <tr className="" key={sl_row.chart_of_accounts_id}>
                                                                    ...
                                                                    <td className="tx-left">{sl_row.chart_of_accounts_accounts_link}</td>
                        ...
                        <form onSubmit={(e) => formSubmit(e)} >
                            <div className="modal-body m-0 pl-3 pr-3 pt-0">
                                ...
                                <div className="row">
                                    <div className="col-md-6 mt-3">
                                        <div className="form-group">
                                            <label className="form-label" htmlFor="chart_of_accounts_accounts_link_id">{lang.accounts_link}</label>
                                            <select type="text" className="form-control border border-info" id="chart_of_accounts_accounts_link_id" name="chart_of_accounts_accounts_link_id" value={chart_of_accounts_accounts_link_id} onChange={(e) => setChart_of_accounts_accounts_link_id(e.target.value)}>
                                                <option value="">{lang.n_a}</option>
                                                {accounts_link_list.map(link_row => (
                                                <option key={link_row.accounts_link_id} value={link_row.accounts_link_id}>{link_row.accounts_link_name}</option>
                                                ))}
                                            </select>
                                        </div>
                                    </div>
