                                ...
                                <tbody>
                                    ...
                                    <tr className='' key={row.user_id}>
                                        ...
                                        <td className="tx-center d-print-none">
                                            {/* <Link className="text-warning mg-r-3" href="#" title={lang.project} onClick={() => viewUser(row.user_id)}><i className="fas fa-eye wd-16 mr-2"></i></Link> */}
                                            {u_user_group == 1 || u_user_group == 2 || u_user_group == 3?
                        ...
                        <form onSubmit={(e) => formSubmit(e)} >
                            <div className="modal-body m-0 pl-3 pr-3 pt-0">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mt-3">
                                        <div className="form-group">
                                            <label className="form-label" htmlFor="user_branch">{lang.project}</label>
